...
sudo docker build --build-arg AAPI_END_POINT=https://<endpoint>:8443/automation-api --build-arg AAPI_USER=user --build-arg AAPI_PASS=password --build-arg AGENT_IMAGE_NAME=Agent_20_200.Linux  --tag uobctmag:9.0.20.200.sfs . 
